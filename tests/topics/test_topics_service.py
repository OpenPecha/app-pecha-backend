...
async def test_get_topics_without_parent():
    with patch('pecha_api.topics.topics_service.get_child_count', new_callable=AsyncMock, return_value=2), \
        patch('pecha_api.topics.topics_service.get_topics_cache', new_callable=AsyncMock, return_value=None), \
        patch('pecha_api.topics.topics_service.set_topics_cache', new_callable=AsyncMock, return_value=None), \
